...
//    static  float OBJECT_SCALE_FLOAT = 0.12f;
    ...
    public static void setkOBJECT_SCALE_FLOAT(float kOBJECT_SCALE_FLOAT) {
        ImageTargetRenderer.kOBJECT_SCALE_FLOAT = kOBJECT_SCALE_FLOAT;
    }
    ...
    public static void setmAngleY(float mAngleY) {
        ImageTargetRenderer.mAngleY = mAngleY;
    }
    ...
    public static void setmAngleX(float mAngleX) {
        ImageTargetRenderer.mAngleX = mAngleX;
    }
...
//            Matrix.scaleM(modelMatrix, 0, OBJECT_SCALE_FLOAT, OBJECT_SCALE_FLOAT, OBJECT_SCALE_FLOAT);
            ...
            Matrix.rotateM(modelMatrix,0,mAngleY, 0, 0, 1);//左右滑动让模型左右转动
            //xyz010  绕着垂直于屏幕轴旋转
            //xyz001  绕着屏幕上下轴旋转
            //xyz100   绕着屏幕左右轴旋转

//            Matrix.rotateM(modelMatrix,0,mAngleX, 1, 0, 0);//上下滑动让模型上下转动
